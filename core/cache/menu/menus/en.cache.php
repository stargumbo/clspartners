...
MODx.msg.confirm({
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'parent' => 'components',
        'action' => 81,
        'description' => 'Manage domains and decide where to start inside your entire website.',
        'icon' => 'images/icons/plugin.gif',
        'menuindex' => 0,
        'params' => '',
        'handler' => '',
  ...
  array (
    ...
    'parent' => '',
    'action' => 0,
    'description' => 'Access to FormSave',
    'icon' => '',
    'menuindex' => 9,
    'params' => '',
    'handler' => '',
    'permissions' => 'menu_forms',
    'controller' => '',
    'namespace' => NULL,
    'children' => 
    array (
      0 => 
      array (
        'text' => 'Loyola Health Form Submissions',
        'parent' => 'Forms',
        'action' => 78,
        'description' => 'Access to FormSave',
        'icon' => '',
