<?php  return array (
  'config' => 
  array (
    'announcement_message' => 'Apply Now for the Fall 2014 Semester',
    'announcement_url' => 'https://ambl.utulsa.edu/formoleaux/mjel-application ',
    'base_url' => '/',
    'bottom_cta' => 'http://signup.utulsaenergylaw.com/',
    'contact_form' => '[[$contactForm_tulsa]]',
    'context_start_page' => '21',
    'error_page' => '22',
    'header_contents' => '<div class="school"><a href="[[~[[*21]]]]"><img alt="Tulsa College" src="[[++site_url]]global_assets/img/logo-trans.png"></a><br /></div>',
    'http_host' => 'energylaw.utulsa.edu',
    'masthead_content' => '<div class="links"><a target="_blank" href="http://www.utulsa.edu/academics/colleges/college-of-law.aspx">COLLEGE OF LAW HOME PAGE</a> | <a target="_blank" href="http://www.utulsa.edu/">UNIVERSITY HOME PAGE</a></div>',
    'site_background' => '<img src="[[++site_url]]global_assets/img/tulsa_bck.jpg" class="bg" />',
    'site_name' => 'THE UNIVERSITY OF TULSA | COLLEGE OF LAW',
    'site_nav' => '[[!getResources? &parents=`0` &limit=`0` &sortby=`` &context=`TulsaEnergyLaw` &resources=`-21,-26` &tpl=`menu_item`]]',
    'site_start' => '21',
    'site_url' => 'http://energylaw.utulsa.edu/',
  ),
  'resourceMap' => 
  array (
    0 => 
  ...
  array (
    'Home.html' => 21,
    'tulsa-degree.html' => 22,
    'online-convenience.html' => 23,
    'curriculum.html' => 24,
    'admissions.html' => 25,
    'our-faculty.html' => 27,
    'board-of-visitors.html' => 28,
    'Thank-You!.html' => 26,
  ),
  'webLinkMap' => 
  array (
