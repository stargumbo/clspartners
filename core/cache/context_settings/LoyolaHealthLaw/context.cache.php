<?php  return array (
  'config' => 
  array (
    'announcement_message' => 'Online Information Session for Health Care Professionals and Attorneys 3/4, 3/10 & 3/19.  Online Information Session for Nurses 3/13.',
    'announcement_url' => 'http://www.luc.edu/law/centers/healthlaw/degrees/info_session.html',
    'base_url' => '/',
    'bottom_cta' => 'http://luc.edu/law/centers/healthlaw/about/vis.html',
    'contact_form' => '[[$contactForm_loyola]]',
    'context_start_page' => '13',
    'error_page' => '14',
    'header_contents' => '<div class="header-text"><a href="http://www.luc.edu/law/">Loyola University Chicago | School Of Law</a></div><div class="school"><a href="[[~2]]">Beazley Institute For Health Law and Policy</a></div>',
    'http_host' => 'onlinehealthlaw.luc.edu',
    'masthead_content' => '<a href="http://www.luc.edu/law/"><img src="[[++site_url]]global_assets/img/logo-masthead.jpg" alt="[[++site_name]]" /></a>',
    'site_background' => '<img src="[[++site_url]]global_assets/img/bck.jpg" class="bg" />',
    'site_name' => 'Loyola University Chicago',
    'site_nav' => '[[!getResources? &parents=`12` &limit=`0` &context=`LoyolaHealthLaw` &resources=`-13,-18` &tpl=`menu_item`]]',
    'site_start' => '11',
    'site_url' => 'http://onlinehealthlaw.luc.edu/',
  ),
  'resourceMap' => 
  array (
    0 => 
  ...
  array (
    'homepage.html' => 11,
    'MJ-LLM/' => 12,
    'MJ-LLM/index.html' => 13,
    'MJ-LLM/loyola-degree.html' => 14,
    'MJ-LLM/thank-you.html' => 18,
    'MJ-LLM/success-stories.html' => 17,
    'MJ-LLM/career-advancement.html' => 16,
    'MJ-LLM/online-convenience.html' => 15,
  ),
  'webLinkMap' => 
  array (
    11 => '[[~[[++context_start_page]]]]',
  ),
  'eventMap' => 
  array (
...
return;',
    ...
    array (
      ...
      'property_preprocess' => '0',
      'name' => 'ContextRouter',
      'description' => 'ContextRouter is a simple plug-and-play plugin allowing you to use different contexts, and, based on the http_host context settings you need to set anyway, it routes your front-end requests as required.',
      'editor_type' => '0',
      'category' => '0',
      'cache_type' => '0',
