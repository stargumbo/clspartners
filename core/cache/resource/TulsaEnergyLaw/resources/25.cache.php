<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p><img style="display: block; margin-left: auto; margin-right: auto;" src="global_assets/img/admissions.jpg" alt="The energy to change the world." width="509" height="281" /><br /> <br /> The MJEL program seeks applicants who bring a wide range of backgrounds, experiences, and perspectives. The MJEL program attracts motivated students who appreciate and embrace the challenge and professional development opportunities offered by a legal education. Admission decisions are competitive and made on a rolling basis. <br /> <br /> MJEL applicants must have obtained a Bachelor\'s degree prior to the start MJEL classes.  Current Bachelor Degree candidates on track to graduate before the MJEL semester begins (Aug. 26, 2013) will be considered.<br /> <br /> The GRE or any other entrance examination is not required as part of the MJEL admissions process.</p>
<p>For more information, please email <a href="mailto:jason-aamodt@utulsa.edu">Jason Aamodt</a> or call 918.631.3051.To apply for the MJEL program, please click <a href="https://ambl.utulsa.edu/formoleaux/mjel-application" target="_blank">here</a>.</p>
<p><strong>Tuition and Fees </strong></p>
<p>The overall cost for the MJEL program is approximately $25,700, which includes all your expenses, books and related items.  There are no hidden fees or charges.  We believe that the MJEL Degree is an exceptional value, with the overall cost being highly competitive with other master degree programs.  </p>
<p>In detail, tuition for the MJEL program is $1,000 per credit hour.  The program requires twenty-four hours for graduation. In addition, you will likely have these additional costs:</p>
<ul>
<li>Textbooks: $600 per year</li>
<li>Personal Digital Certificate: $19.95 per year</li>
<li>Microsoft Word or WordPerfect: $70 (student rate)</li>
<li>Travel and lodging (for annual Education Immersion Weekends): $1,000 per weekend</li>
</ul>
<p><strong>Financial Aid</strong><br /> There are a number of private and government loan programs available to students who are interested in online degree programs. <a href="http://www.utulsa.edu/financialaid" target="_blank">Click here</a> for more information regarding financial aid, or contact Kristi Emerson at 918.631.3325</p>
<div><strong>Scholarships</strong><br />The University of Tulsa College of Law Master of Jurisprudence Energy and Indian Law (MJEL and MJIL) programs are proud to offer scholarship opportunities to returning and new students. These scholarship opportunities were made possible by a generous gift from the Clean Line Energy Partners. Scholarships range in amount from $1,000 to $3,000.</div>
<div> </div>
<div> </div>',
    'richtext' => 1,
    'template' => 1,
...
<head>	<meta charset="utf-8" />
	<title>THE UNIVERSITY OF TULSA | COLLEGE OF LAW - Admissions</title>
	<base href="[[!++site_url]]" />
...
<body class="id-25 TulsaEnergyLaw">
	[[!$analytics-tulsa]]
...
<form id="contact-form" action="admissions.html" method="post">
	...
	<p class="form-text" style="margin-bottom:10px text-align:center;">
		...
		<div id="content" class="[[*pagetitle:is=`Thank You!`:then=`thanks-page`]]">
			<p><img style="display: block; margin-left: auto; margin-right: auto;" src="global_assets/img/admissions.jpg" alt="The energy to change the world." width="509" height="281" /><br /> <br /> The MJEL program seeks applicants who bring a wide range of backgrounds, experiences, and perspectives. The MJEL program attracts motivated students who appreciate and embrace the challenge and professional development opportunities offered by a legal education. Admission decisions are competitive and made on a rolling basis. <br /> <br /> MJEL applicants must have obtained a Bachelor\'s degree prior to the start MJEL classes.  Current Bachelor Degree candidates on track to graduate before the MJEL semester begins (Aug. 26, 2013) will be considered.<br /> <br /> The GRE or any other entrance examination is not required as part of the MJEL admissions process.</p>
<p>For more information, please email <a href="mailto:jason-aamodt@utulsa.edu">Jason Aamodt</a> or call 918.631.3051.To apply for the MJEL program, please click <a href="https://ambl.utulsa.edu/formoleaux/mjel-application" target="_blank">here</a>.</p>
<p><strong>Tuition and Fees </strong></p>
<p>The overall cost for the MJEL program is approximately $25,700, which includes all your expenses, books and related items.  There are no hidden fees or charges.  We believe that the MJEL Degree is an exceptional value, with the overall cost being highly competitive with other master degree programs.  </p>
<p>In detail, tuition for the MJEL program is $1,000 per credit hour.  The program requires twenty-four hours for graduation. In addition, you will likely have these additional costs:</p>
...
document.write(\'<iframe style="position:absolute; visibility:hidden; width:1px; height:1px;" src="http://servedby.flashtalking.com/container/3546;23170;2810;iframe/?spotName=Loyola_Health_Law_Homepage&cachebuster=\'+ftRandom+\'"></iframe>\');
    ...
    '[[*analyticsLabel]]' => 'PVNLCOvmpQQQxb7Y3QM',
...
var google_conversion_label = "PVNLCOvmpQQQxb7Y3QM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/1001791301/?value=0&amp;label=PVNLCOvmpQQQxb7Y3QM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
