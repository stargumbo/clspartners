<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'A Tulsa Degree',
    'longtitle' => '',
    'description' => 'A Loyola Degree',
    'alias' => 'tulsa-degree',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    ...
    'parent' => 0,
    'isfolder' => 0,
    'introtext' => 'A Loyola Degree',
    'content' => '<p><img style="display: block; margin-left: auto; margin-right: auto;" src="global_assets/img/tulsadegree.jpg" alt="The energy to change the world." width="507" height="280" /><br /> <br /> Energy is at the core of every business practice, from retail to internet services, to transportation and exploration and beyond.  Each business sector needs to control and manage energy costs to the greatest extent possible.  Having a knowledge and command of Energy Law is an excellent way to gain the competitive advantage that comes from lower energy costs. </p>
<p>Energy Law is really a combination of estate law, oil and gas law, natural resources law, administrative law, and economics and environmental law.  It is also a prime mover in corporate law and taxation, and criminal law and legislation. The MJEL curriculum encompasses much of what the Energy Law program at TU offers as a whole, with a focus on the production, transportation, and use of energy.<br /> <br /> Our MJEL classes are taught by law professors, practicing lawyers, and energy professionals who have first-hand experience producing, transporting, selling and using energy in business on a daily basis.  As an MJEL student, you will learn about and discover insights into interstate and intrastate energy transportation regulations, state and federal oil and gas production regulations, the laws permitting the use of public natural resources, and the laws relating to the development of and access to alternative energy.<br /> <br /> The <a href="http://www.utulsa.edu/law/">University of Tulsa College of Law</a>  created the MJEL program to meet the expressed desire of energy professionals to gain a sophisticated knowledge of the laws and regulations that govern the energy industry.  Now, through TU’s affiliation with <a href="http://concordlawschool.edu/">Concord Law School </a>, a pioneer in online legal education which offered its first online law degree in 1998, the MJEL is a unique resource available to any person in the world who wants to study energy law, without necessarily becoming an attorney.  <br /> <br /> The University of Tulsa College of Law is located in the heartland of America’s energy industry, and provides access to an energy-centric powerhouse that is unique to TU:</p>
<p><a href="http://www.felj.org/journal.php">Energy Law Journal,</a> a joint publication of The University of Tulsa<br /> ABA Year in Review: Environment, Energy and Resources Law - Published by the Tulsa Law School and the ABA<br /> College of Law and the <a href="http://www.eba-net.org/">Energy Bar Association</a> in Washington, DC <br /> <a href="http://www.utulsa.edu/academics/colleges/collins-college-of-business/Centers-and-Institutes/NEPI.aspx">National Energy Policy Institute,</a> located at The University of Tulsa <br /> <a href="http://www.utulsa.edu/academics/colleges/college-of-engineering-and-natural-sciences/departments-and-schools/mcdougall-school-of-petroleum-engineering.aspx">McDougall School of Petroleum Engineering</a> one of the preeminent programs in the world<br /> <a href="http://www.utulsa.edu/academics/colleges/collins-college-of-business/bus-dept-schools/Energy-Management-Program.aspx">Energy Management Center,</a> located within the TU Collins College of Business</p>
<div> </div>
<p> </p>
...
<p> </p>',
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1386341582,
    'editedby' => 1,
    'editedon' => 1391196689,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1367950080,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    'context_key' => 'TulsaEnergyLaw',
    'content_type' => 1,
    'uri' => 'tulsa-degree.html',
    'uri_override' => 0,
...
<head>	<meta charset="utf-8" />
	<title>THE UNIVERSITY OF TULSA | COLLEGE OF LAW - A Tulsa Degree</title>
	<base href="[[!++site_url]]" />
	...
	<!-- Stylesheets -->
	<link rel="stylesheet" href="http://energylaw.utulsa.edu/global_assets/css/style.css" />
	<link rel="stylesheet" media="print" href="http://energylaw.utulsa.edu/global_assets/css/print.css" />
	<link href=\'http://fonts.googleapis.com/css?family=Alfa+Slab+One\' rel=\'stylesheet\' type=\'text/css\' />
	<!--[if (lt IE 9) & (!IEMobile)]>
	<script src="http://energylaw.utulsa.edu/global_assets/js/libs/selectivizr-1.0.2.min.js"></script>
	<![endif]-->
	<!-- HTML5 Support -->
	<script src="http://energylaw.utulsa.edu/global_assets/js/libs/modernizr-2.6.2.min.js"></script></head>
<body class="id-22 TulsaEnergyLaw">
	[[!$analytics-tulsa]]
	[[*context_key:is=`LoyolaHealthLaw`:then=`[[!$analytics-healthlaw]]`]]
	<img src="http://energylaw.utulsa.edu/global_assets/img/tulsa_bck.jpg" class="bg" />

	<div id="masthead">
		<div class="position"><div class="links"><a target="_blank" href="http://www.utulsa.edu/academics/colleges/college-of-law.aspx">COLLEGE OF LAW HOME PAGE</a> | <a target="_blank" href="http://www.utulsa.edu/">UNIVERSITY HOME PAGE</a></div></div>
	</div>
	<div id="header"><div class="school"><a href=""><img alt="Tulsa College" src="http://energylaw.utulsa.edu/global_assets/img/logo-trans.png"></a><br /></div></div>
	<div id="nav"><ul>[[!getResources? &parents=`0` &limit=`0` &sortby=`` &context=`TulsaEnergyLaw` &resources=`-21,-26` &tpl=`menu_item`]]</ul></div>
	...
	&fsFormTopic=`TulsaEnergyLaw`
	&redirectTo=`26`
&validate=`emailaddress:blank`
]]

<a href="javascript:void(0);" class="close-box">Close Form</a>
<h2>Advance your career.<br />Expand your horizon.</h2>

<form id="contact-form" action="tulsa-degree.html" method="post">
	...
	<table border="0" cellspacing="0" cellpadding="0" style="width:100%;">
		<tr>
			<td><select name="state" id="state" class="input-menu" style="width:100px; margin-top:4px;margin-bottom:4px;">[[!FormItStateOptions? &selected=`[[!+fi.state]]`]]</select></td>
			<td><input name="zip" id="zip" class="input-field zip required" style="margin-left:10px;" value="[[!+fi.zip:default=`Zip`]]" maxlength="7" /><br /></td>
		</tr>
		<tr>
			<td colspan="2"><select name="country" id="country" style="margin-bottom:4px;" class="input-menu country">[[!FormItCountryOptions? &selected=`[[+fi.country]]`]]</select></td>
		</tr>
	</table>
	<table border="0" cellspacing="0" cellpadding="0" style="width:100%;">
		<tr>
			...
			<td><input name="phone" id="phone" class="input-field phone" style="margin-left:10px;" value="[[!+fi.phone:default=`Phone Number`]]" /></td>
		</tr>
	</table>
	<input name="email" id="email" class="input-field email required" value="[[!+fi.email:default=`Email`]]" />
	<div class="form-text">
		Do you have a bachelors degree?<br />
		<input type="radio" name="bachelors[]" id="bachelors1" value="Yes" [[!+fi.bachelors:FormItIsChecked=`Yes`]] />
		<span class="form-margin">Yes</span><br />
		<input type="radio" name="bachelors[]" id="bachelors2" value="No" [[!+fi.bachelors:FormItIsChecked=`No`]] />
		<span class="form-margin">No</span><br />
		Questions or Comments:<br />
		<textarea name="otherText" id="otherText" class="input-field" value="[[!+fi.otherText]]" rows="4" cols="15" maxlength="35">&nbsp;</textarea><br /><br />
	</div>
	...
	<p class="form-text" style="margin-bottom:10px text-align:center;">
		...
		<div id="content" class="[[*pagetitle:is=`Thank You!`:then=`thanks-page`]]">
			<p><img style="display: block; margin-left: auto; margin-right: auto;" src="global_assets/img/tulsadegree.jpg" alt="The energy to change the world." width="507" height="280" /><br /> <br /> Energy is at the core of every business practice, from retail to internet services, to transportation and exploration and beyond.  Each business sector needs to control and manage energy costs to the greatest extent possible.  Having a knowledge and command of Energy Law is an excellent way to gain the competitive advantage that comes from lower energy costs. </p>
<p>Energy Law is really a combination of estate law, oil and gas law, natural resources law, administrative law, and economics and environmental law.  It is also a prime mover in corporate law and taxation, and criminal law and legislation. The MJEL curriculum encompasses much of what the Energy Law program at TU offers as a whole, with a focus on the production, transportation, and use of energy.<br /> <br /> Our MJEL classes are taught by law professors, practicing lawyers, and energy professionals who have first-hand experience producing, transporting, selling and using energy in business on a daily basis.  As an MJEL student, you will learn about and discover insights into interstate and intrastate energy transportation regulations, state and federal oil and gas production regulations, the laws permitting the use of public natural resources, and the laws relating to the development of and access to alternative energy.<br /> <br /> The <a href="http://www.utulsa.edu/law/">University of Tulsa College of Law</a>  created the MJEL program to meet the expressed desire of energy professionals to gain a sophisticated knowledge of the laws and regulations that govern the energy industry.  Now, through TU’s affiliation with <a href="http://concordlawschool.edu/">Concord Law School </a>, a pioneer in online legal education which offered its first online law degree in 1998, the MJEL is a unique resource available to any person in the world who wants to study energy law, without necessarily becoming an attorney.  <br /> <br /> The University of Tulsa College of Law is located in the heartland of America’s energy industry, and provides access to an energy-centric powerhouse that is unique to TU:</p>
<p><a href="http://www.felj.org/journal.php">Energy Law Journal,</a> a joint publication of The University of Tulsa<br /> ABA Year in Review: Environment, Energy and Resources Law - Published by the Tulsa Law School and the ABA<br /> College of Law and the <a href="http://www.eba-net.org/">Energy Bar Association</a> in Washington, DC <br /> <a href="http://www.utulsa.edu/academics/colleges/collins-college-of-business/Centers-and-Institutes/NEPI.aspx">National Energy Policy Institute,</a> located at The University of Tulsa <br /> <a href="http://www.utulsa.edu/academics/colleges/college-of-engineering-and-natural-sciences/departments-and-schools/mcdougall-school-of-petroleum-engineering.aspx">McDougall School of Petroleum Engineering</a> one of the preeminent programs in the world<br /> <a href="http://www.utulsa.edu/academics/colleges/collins-college-of-business/bus-dept-schools/Energy-Management-Program.aspx">Energy Management Center,</a> located within the TU Collins College of Business</p>
<div> </div>
<p> </p>
<div class="center"> </div>
<p> </p>
			<a href="http://signup.utulsaenergylaw.com/" target="_blank" style="display:block;text-decoration:none;">
				<div id="virtual-session">
					<div id="virtual-copy"><p>Register for our Next Informational Webinar<br /><span class=""><em>Click here for more information</em></span></p></div>
					<div id="virtual-arrow"><img width="21" height="34" alt="Arrow" src="http://energylaw.utulsa.edu/global_assets/img/arrow.png" /></div>
				</div>
			</a>
		</div>
	</div>
	...
	<!-- JavaScript -->
<script type="text/javascript" src="http://energylaw.utulsa.edu/global_assets/js/libs/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="http://code.jquery.com/ui/1.10.2/jquery-ui.js"></script>
<script type="text/javascript" src="http://energylaw.utulsa.edu/global_assets/js/plugins.js"></script>
<script type="text/javascript" src="http://energylaw.utulsa.edu/global_assets/js/custom.js"></script>
<script type="text/javascript" src="http://energylaw.utulsa.edu/global_assets/js/libs/helper.js"></script>
  ...
  array (
	...
	<![endif]-->
	<!-- HTML5 Support -->
	<script src="http://energylaw.utulsa.edu/global_assets/js/libs/modernizr-2.6.2.min.js"></script>',
    '[[*id]]' => 22,
    '[[*context_key]]' => 'TulsaEnergyLaw',
    '[[*context_key:is=`TulsaEnergyLaw`:then=`[[!$analytics-tulsa]]`]]' => '[[!$analytics-tulsa]]',
    '[[*context_key:is=`LoyolaHealthLaw`:then=`[[!$analytics-healthlaw]]`]]' => NULL,
    '[[*pagetitle:is=`Thank You!`:then=`thanks-page`]]' => NULL,
    '[[~22]]' => 'tulsa-degree.html',
    '[[$contactForm_tulsa]]' => '[[!FormIt?
	&hooks=`FormSave,redirect`
	&fsFormTopic=`TulsaEnergyLaw`
	&redirectTo=`26`
&validate=`emailaddress:blank`
...
',
    '[[*context_key:is=`TulsaEnergyLaw`:then=`Register for our Next Informational Webinar`:else=`Register for our next Online Virtual Information Session.`]]' => 'Register for our Next Informational Webinar',
...
document.write(\'<iframe style="position:absolute; visibility:hidden; width:1px; height:1px;" src="http://servedby.flashtalking.com/container/3546;23170;2810;iframe/?spotName=Loyola_Health_Law_Homepage&cachebuster=\'+ftRandom+\'"></iframe>\');
    ...
    '[[*analyticsLabel]]' => 'X7E5CKPvpQQQxb7Y3QM',
...
var google_conversion_label = "X7E5CKPvpQQQxb7Y3QM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/1001791301/?value=0&amp;label=X7E5CKPvpQQQxb7Y3QM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
...
<script>
  ...
  ga(\'send\', \'pageview\');
    ...
    '[[~23]]' => 'online-convenience.html',
    '[[~24]]' => 'curriculum.html',
    '[[~25]]' => 'admissions.html',
    '[[~27]]' => 'our-faculty.html',
    '[[~28]]' => 'board-of-visitors.html',
  ),
  'sourceCache' => 
  array (
    'modChunk' => 
