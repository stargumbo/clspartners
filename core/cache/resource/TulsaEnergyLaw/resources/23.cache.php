<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Online Convenience',
    'longtitle' => '',
    'description' => '',
    'alias' => 'online-convenience',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p><img style="display: block; margin-left: auto; margin-right: auto;" src="global_assets/img/conveninence.jpg" alt="The energy to change the world." width="507" height="280" /><br /> <br /> Prior to Tulsa and Concord\'s unique collaboration, an Energy Law education was mostly accessible to attorneys who lived in large metropolitan areas. Today, you can study Energy Law wherever and whenever you connect to the Internet, and gain access to a learning environment that is surprisingly personalized.  As many professionals in the industry already know, you do not have be an attorney to learn or use Energy Law to great advantage for your organization and yourself.<br /> <br /> The benefits of Online learning at TU College of Law are immediate and self-evident: <br /> <br /> <strong>Flexibility</strong>. With the competing demands of work and family responsibilities, many cannot attend classroom-based programs requiring a fixed schedule and location. TU’s virtual halls never close. <br /> <br /> <strong>Convenience</strong>. Admitted students do not have to move, change employment, or even commute to take advantage of an Energy Law education at TU. <br /> <br /> <strong>Ease of Use</strong>.  Video lectures are accessible 24-7.  Assignments are turned in and returned with in-depth feedback to the student\'s homepage within days.  Student services are available at the click of a mouse.</p>
<p><a style="display: block; text-decoration: none;" href="http://signup.utulsaenergylaw.com/?utm_source=&amp;utm_medium=&amp;utm_campaign=" target="_blank"><!-- /virtual session --> </a></p>',
    'richtext' => 1,
    'template' => 1,
    'menuindex' => 2,
    'searchable' => 1,
...
<head>	<meta charset="utf-8" />
	<title>THE UNIVERSITY OF TULSA | COLLEGE OF LAW - Online Convenience</title>
	<base href="[[!++site_url]]" />
...
<body class="id-23 TulsaEnergyLaw">
	[[!$analytics-tulsa]]
...
<form id="contact-form" action="online-convenience.html" method="post">
	...
	<p class="form-text" style="margin-bottom:10px text-align:center;">
		...
		<div id="content" class="[[*pagetitle:is=`Thank You!`:then=`thanks-page`]]">
			<p><img style="display: block; margin-left: auto; margin-right: auto;" src="global_assets/img/conveninence.jpg" alt="The energy to change the world." width="507" height="280" /><br /> <br /> Prior to Tulsa and Concord\'s unique collaboration, an Energy Law education was mostly accessible to attorneys who lived in large metropolitan areas. Today, you can study Energy Law wherever and whenever you connect to the Internet, and gain access to a learning environment that is surprisingly personalized.  As many professionals in the industry already know, you do not have be an attorney to learn or use Energy Law to great advantage for your organization and yourself.<br /> <br /> The benefits of Online learning at TU College of Law are immediate and self-evident: <br /> <br /> <strong>Flexibility</strong>. With the competing demands of work and family responsibilities, many cannot attend classroom-based programs requiring a fixed schedule and location. TU’s virtual halls never close. <br /> <br /> <strong>Convenience</strong>. Admitted students do not have to move, change employment, or even commute to take advantage of an Energy Law education at TU. <br /> <br /> <strong>Ease of Use</strong>.  Video lectures are accessible 24-7.  Assignments are turned in and returned with in-depth feedback to the student\'s homepage within days.  Student services are available at the click of a mouse.</p>
<p><a style="display: block; text-decoration: none;" href="http://signup.utulsaenergylaw.com/?utm_source=&amp;utm_medium=&amp;utm_campaign=" target="_blank"><!-- /virtual session --> </a></p>
...
document.write(\'<iframe style="position:absolute; visibility:hidden; width:1px; height:1px;" src="http://servedby.flashtalking.com/container/3546;23170;2810;iframe/?spotName=Loyola_Health_Law_Homepage&cachebuster=\'+ftRandom+\'"></iframe>\');
    ...
    '[[*analyticsLabel]]' => 'jLWTCNPppQQQxb7Y3QM',
...
var google_conversion_label = "jLWTCNPppQQQxb7Y3QM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/1001791301/?value=0&amp;label=jLWTCNPppQQQxb7Y3QM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
