<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p><img style="display: block; margin-left: auto; margin-right: auto;" src="global_assets/img/cirriculum.jpg" alt="The energy to change the world." width="507" height="280" /><br /> <br /> We are confident you will find the MJEL Curriculum to be the most advanced in Energy, Environmental and Natural Resources law.  Overall, 24 credits are required to obtain the full degree. The following describes each course, and identifies those which are required, and those which are electives.</p>
<p><strong>Energy Research, Analysis &amp; Writing (3 credits/required)</strong><br /> Students become familiar with the sources of law applicable to the energy industry, as well as sources for legal commentary, legal research methodology, legal analysis and application, writing techniques, rules of citation and document formats. Students produce high-quality writing and obtain the fundamentals necessary to complete their thesis in energy law.</p>
<p><strong>Regulation of Energy Markets (3 credits/required)</strong><br /> This course provides insight to state, public utility and federal regulation of electric power, natural gas and oil markets. Students master administrative law issues, focusing on the identity and role of regulations and regulatory agencies.</p>
<p><strong>Basic Oil and Gas Law   (3 credits/required)</strong><br /> Students develop important fundamental skills emphasizing the accumulation, ownership and conservation of oil and gas, the intricacies of oil and gas leasing, implied rules in the oil and gas lease, the nature protection of legal interests in oil and gas, the title and conveyance of oil and gas interest and the use pooling and unitization to access resources.</p>
<p><strong>Environmental Law (3 credits/required)</strong><br /> Students gain experience with the Clean Air Act, the Clean Water Act and the law of hazardous and other regulated substances, including RCRA and CERCLA. The study includes real-life, on-going matters and projects addressing the most active environmental questions relating to the energy industry.</p>
<p><strong>Advanced Oil &amp; Gas Law (3 credits/elective)</strong><br /> By addressing and solving real-world problems, students gain in-depth knowledge of complex oil and gas exploration, production, marketing and conveyance agreements, as well as their related documents. In addition, students learn the purpose, structure and judicial interpretation of oil and gas instruments, and how to problem-solve complex oil and gas conservation practices such as pooling, unitization and pro-rationing.</p>
<p><strong>Applied Environmental Law (3 credits/elective)</strong><br /> Using a fact-based approach, students learn best practices and the skills to address real-world environmental case studies relating to energy development and focusing on the laws and regulations addressed in Environmental Law, the Endangered Species Act and the National Environmental Policy Act.  Depending on the recent issues of concern, the curriculum could potentially cover the Oil Pollution Act or the Safe Drinking Water Act.</p>
<p><strong>Renewable Energy Development (3 credits/elective)</strong><br /> Students explore one of the solutions to the world’s dependence on fossil fuels: energy obtained from renewable sources. Topics include renewable energy, alternative fuels, de-carbonization and energy security solutions. Students focus on the comparison of renewable technologies with fossil fuels and against each other. Barriers and opportunities of integration and proliferation of renewable energy are also explored.  </p>
<p>Key issues addressed include the concerns relating to financing of renewable energy, as well as the permitting, siting and administrative approval of renewable energy projects.  An interdisciplinary approach features learning materials from law, economics, sociology, environmental science and engineering.</p>
<p><strong>Natural Resources &amp; Water Law (3 credits/elective)</strong><br /> Students learn the law of the right to use of water and other non-energy natural resources and address the law of the ownership and development of resources on federal lands. Potential areas of study may also include: Federal Land Policy Management Act, the Coastal Zone Management Act, the Outer Continental Shelf Lands Act, National Environmental Policy Act, the Multiple Use and Sustained Yield Act, the General Mining Law and the Endangered Species Act.</p>
<p><strong>Energy Law Thesis (3 credits/required)</strong><br /> In a focused environment, students are paired with an advisor to help refine their thesis topics, guide research and aid in the successful completion of their thesis. Students produce a quality, publishable thesis and are encouraged to select a topic that will bring value to their workplace or prepare them for career advancement.  </p>
<p>In addition, one course from the <a href="http://indianlawmj.org/courses-overview/" target="_blank">Tulsa Master of Jurisprudence in Indian Law Program</a> may be substituted for one of your electives.</p>
<p> </p>
...
<head>	<meta charset="utf-8" />
	<title>THE UNIVERSITY OF TULSA | COLLEGE OF LAW - Curriculum</title>
	<base href="[[!++site_url]]" />
...
<body class="id-24 TulsaEnergyLaw">
	[[!$analytics-tulsa]]
...
<form id="contact-form" action="curriculum.html" method="post">
	...
	<p class="form-text" style="margin-bottom:10px text-align:center;">
		...
		<div id="content" class="[[*pagetitle:is=`Thank You!`:then=`thanks-page`]]">
			<p><img style="display: block; margin-left: auto; margin-right: auto;" src="global_assets/img/cirriculum.jpg" alt="The energy to change the world." width="507" height="280" /><br /> <br /> We are confident you will find the MJEL Curriculum to be the most advanced in Energy, Environmental and Natural Resources law.  Overall, 24 credits are required to obtain the full degree. The following describes each course, and identifies those which are required, and those which are electives.</p>
<p><strong>Energy Research, Analysis &amp; Writing (3 credits/required)</strong><br /> Students become familiar with the sources of law applicable to the energy industry, as well as sources for legal commentary, legal research methodology, legal analysis and application, writing techniques, rules of citation and document formats. Students produce high-quality writing and obtain the fundamentals necessary to complete their thesis in energy law.</p>
<p><strong>Regulation of Energy Markets (3 credits/required)</strong><br /> This course provides insight to state, public utility and federal regulation of electric power, natural gas and oil markets. Students master administrative law issues, focusing on the identity and role of regulations and regulatory agencies.</p>
<p><strong>Basic Oil and Gas Law   (3 credits/required)</strong><br /> Students develop important fundamental skills emphasizing the accumulation, ownership and conservation of oil and gas, the intricacies of oil and gas leasing, implied rules in the oil and gas lease, the nature protection of legal interests in oil and gas, the title and conveyance of oil and gas interest and the use pooling and unitization to access resources.</p>
<p><strong>Environmental Law (3 credits/required)</strong><br /> Students gain experience with the Clean Air Act, the Clean Water Act and the law of hazardous and other regulated substances, including RCRA and CERCLA. The study includes real-life, on-going matters and projects addressing the most active environmental questions relating to the energy industry.</p>
...
document.write(\'<iframe style="position:absolute; visibility:hidden; width:1px; height:1px;" src="http://servedby.flashtalking.com/container/3546;23170;2810;iframe/?spotName=Loyola_Health_Law_Homepage&cachebuster=\'+ftRandom+\'"></iframe>\');
    ...
    '[[*analyticsLabel]]' => 'kdDqCOPnpQQQxb7Y3QM',
...
var google_conversion_label = "kdDqCOPnpQQQxb7Y3QM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/1001791301/?value=0&amp;label=kdDqCOPnpQQQxb7Y3QM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
