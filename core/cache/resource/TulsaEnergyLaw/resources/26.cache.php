...
<p>Designed for professionals like you who deal with real world energy issues each day, the MJEL program\'s online curriculum is truly the first of its kind. Developed by the University of Tulsa College of Law, and hosted by Concord Law on its state-of-the-art online platform, the MJEL program offers a unique opportunity to enhance your energy education and widen your professional horizons. We trust that you will be enriched by the depth of the MJEL program and pleased with its flexibility and simplicity - wherever and whenever you need it.</p>
<p>If you would like to speak with the Program Director, please call:<br /><br /> Jason Aamodt<br /> Assistant Dean for Online Education<br /> (918) 631-3051<br /> Or, email at <a href="mailto:Jason-aamodt@utulsa.edu">Jason-aamodt@utulsa.edu</a></p>',
    'richtext' => 1,
    'template' => 1,
    'menuindex' => 7,
    'searchable' => 1,
...
<head>	<meta charset="utf-8" />
	<title>THE UNIVERSITY OF TULSA | COLLEGE OF LAW - Thank You!</title>
	<base href="[[!++site_url]]" />
...
<body class="id-26 TulsaEnergyLaw">
	[[!$analytics-tulsa]]
...
document.write(\'<iframe style="position:absolute; visibility:hidden; width:1px; height:1px;" src="http://servedby.flashtalking.com/container/3546;23175;2810;iframe/?spotName=Loyola_Health_Law_Thank_You&cachebuster=\'+ftRandom+\'"></iframe>\');
    ...
    '[[*analyticsLabel]]' => 'diWrCLOqpAQQxb7Y3QM',
...
var google_conversion_label = "diWrCLOqpAQQxb7Y3QM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/1001791301/?value=0&amp;label=diWrCLOqpAQQxb7Y3QM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
