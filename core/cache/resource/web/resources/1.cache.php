<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '[[!getResources? &amp;parents=`-1` &amp;resources=`11,21,31` &tpl=`tpl_url-list`]]',
    'richtext' => 1,
    'template' => 2,
    'menuindex' => 0,
    'searchable' => 0,
...
<head>
	<meta charset="utf-8" />
	<title>Kaplan University Online Programs - Home</title>
	<base href="[[!++site_url]]" />
	...
	<!-- Stylesheets -->
	<link rel="stylesheet" href="http://staging2.bvk.com/global_assets/css/style.css" />
	<link rel="stylesheet" media="print" href="http://staging2.bvk.com/global_assets/css/print.css" />
	<link href=\'http://fonts.googleapis.com/css?family=Alfa+Slab+One\' rel=\'stylesheet\' type=\'text/css\' />
	<!--[if (lt IE 9) & (!IEMobile)]>
	<script src="http://staging2.bvk.com/global_assets/js/libs/selectivizr-1.0.2.min.js"></script>
	<![endif]-->
	<!-- HTML5 Support -->
	<script src="http://staging2.bvk.com/global_assets/js/libs/modernizr-2.6.2.min.js"></script>
</head>
<body>
[[!getResources? &amp;parents=`-1` &amp;resources=`11,21,31` &tpl=`tpl_url-list`]]
</body>
</html>
',
    '_isForward' => false,
  ...
  array (
	...
	<!-- HTML5 Support -->
	<script src="http://staging2.bvk.com/global_assets/js/libs/modernizr-2.6.2.min.js"></script>',
    '[[myMakeURL? &id=`21`]]' => 'http://energylaw.utulsa.edu/',
    '[[myMakeURL? &id=`31`]]' => 'http://onlinebusinesslaw.luc.edu/',
    '[[myMakeURL? &id=`11`]]' => 'http://onlinehealthlaw.luc.edu/',
  ),
  'sourceCache' => 
  array (
    'modChunk' => 
...
return $output;',
      ...
      array (
        ...
        array (
          ...
          'category' => 0,
          'cache_type' => 0,
          'snippet' => '$id = $modx->getOption(\'id\',$scriptProperties,1);
...
return $modx->makeUrl($id,$context,$args,$scheme);',
          ...
          'static' => false,
          'static_file' => '',
          'content' => '$id = $modx->getOption(\'id\',$scriptProperties,1);
$context = $modx->getOption(\'context\',$scriptProperties,\'\');
$args = $modx->getOption(\'args\',$scriptProperties,\'\');
$scheme = $modx->getOption(\'scheme\',$scriptProperties,\'full\');
