<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p class="centered" style="padding: 0; margin: 0;"><img src="global_assets/img/home-img.jpg" alt="Home Image" width="511" height="280" /></p>
<div id="homecolor">
<h2><em>Enhance</em> your knowledge. <em>Advance</em> your career</h2>
</div>
<p>As the saying goes, the future is now—especially in health law. With the world of health care constantly changing, experts in health law are in demand and on the rise.</p>
<p>Health care professionals can take the next step in career success with an online Master of Jurisprudence in Health Law Degree (MJ) from the Beazley Institute for Health Law and Policy at Loyola University Chicago School of Law.</p>
<p>And for those who are attorneys, an online Master of Laws (LLM) in Health Law creates excellent opportunities for specialization and career advancement.</p>
<p>The Beazley Institute for Health Law and Policy is nationally recognized as a leader in health law. And now, with these exceptional online degree opportunities, you can be recognized as a health law expert—all online, in the way that works best for you.</p>',
    'richtext' => 1,
    'template' => 1,
    'menuindex' => 0,
    'searchable' => 1,
...
<body class="id-13 LoyolaHealthLaw">
...
<form id="contact-form" action="MJ-LLM/index.html" method="post" class="loyola-contact-form">
	...
	<p class="form-text" style="margin-bottom:10px text-align:center;">
		...
		<div id="content" class="[[*pagetitle:is=`Thank You!`:then=`thanks-page`]]">
			<p class="centered" style="padding: 0; margin: 0;"><img src="global_assets/img/home-img.jpg" alt="Home Image" width="511" height="280" /></p>
<div id="homecolor">
<h2><em>Enhance</em> your knowledge. <em>Advance</em> your career</h2>
</div>
<p>As the saying goes, the future is now—especially in health law. With the world of health care constantly changing, experts in health law are in demand and on the rise.</p>
