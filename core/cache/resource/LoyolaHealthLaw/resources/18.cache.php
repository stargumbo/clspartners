<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<div class="page-title">Thank You</div>
<p class="p1">Thank you for your interest in our health law master\'s programs specially designed for health care professionals and attorneys who need to know more about the laws and regulations that govern the health care industry.</p>
<p class="p1">The MJ and LLM programs are recognized, legitimate legal credentials for those looking to move into positions of health care leadership and policy making. Plus, these programs are 100% Online, offering maximum flexibility and convenience for full-time professionals. To learn more about the MJ and LLM programs and the Beazley Institute for Health Law and Policy, please visit: <a href="http://www.LUC.edu/healthlaw">www.LUC.edu/healthlaw</a>.</p>',
    'richtext' => 1,
    'template' => 1,
    'menuindex' => 2,
    'searchable' => 1,
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1385071996,
    'editedby' => 1,
    'editedon' => 1386343642,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1368022560,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    'context_key' => 'LoyolaHealthLaw',
    'content_type' => 1,
    'uri' => 'MJ-LLM/thank-you.html',
    'uri_override' => 0,
...
<head>	<meta charset="utf-8" />
	<title>Loyola University Chicago - Thank You!</title>
	<base href="[[!++site_url]]" />
	...
	<!-- Stylesheets -->
	<link rel="stylesheet" href="http://onlinehealthlaw.luc.edu/global_assets/css/style.css" />
	<link rel="stylesheet" media="print" href="http://onlinehealthlaw.luc.edu/global_assets/css/print.css" />
	<link href=\'http://fonts.googleapis.com/css?family=Alfa+Slab+One\' rel=\'stylesheet\' type=\'text/css\' />
	<!--[if (lt IE 9) & (!IEMobile)]>
	<script src="http://onlinehealthlaw.luc.edu/global_assets/js/libs/selectivizr-1.0.2.min.js"></script>
	<![endif]-->
	<!-- HTML5 Support -->
	<script src="http://onlinehealthlaw.luc.edu/global_assets/js/libs/modernizr-2.6.2.min.js"></script></head>
<body class="id-18 LoyolaHealthLaw">
	[[*context_key:is=`TulsaEnergyLaw`:then=`[[!$analytics-tulsa]]`]]
	[[!$analytics-healthlaw]]
	<img src="http://onlinehealthlaw.luc.edu/global_assets/img/bck.jpg" class="bg" />

	<div id="masthead">
		<div class="position"><a href="http://www.luc.edu/law/"><img src="http://onlinehealthlaw.luc.edu/global_assets/img/logo-masthead.jpg" alt="Loyola University Chicago" /></a></div>
	</div>
	<div id="header"><div class="header-text"><a href="http://www.luc.edu/law/">Loyola University Chicago | School Of Law</a></div><div class="school"><a href="">Beazley Institute For Health Law and Policy</a></div></div>
	<div id="nav"><ul>[[!getResources? &parents=`12` &limit=`0` &context=`LoyolaHealthLaw` &resources=`-13,-18` &tpl=`menu_item`]]</ul></div>
	...
	<div class="row">
		<div id="form-wrapper" class="thanks-page">[[!FormIt?
...
<h2><em>Start here</em> for a health law degree that can take you almost anywhere.</h2>

<form id="contact-form" action="MJ-LLM/thank-you.html" method="post" class="loyola-contact-form">
	...
	<div class="form-text">
		Are you an Attorney or Health Care Professional	<br />
		<input class="radio-atty" type="radio" name="attyHCP[]" id="prof0" value="LLM" [[!+fi.attyHCP:FormItIsChecked=`LLM`]] />
		<span class="form-margin">Attorney</span><br />
		<input class="radio-atty" type="radio" name="attyHCP[]" id="prof1" value="MJ" [[!+fi.attyHCP:FormItIsChecked=`MJ`]] />
		<span class="form-margin">Health Care Professional</span><br />
		<input class="radio-atty" type="radio" name="attyHCP[]" id="prof2" value="LLM" [[!+fi.attyHCP:FormItIsChecked=`LLM`]] />
		<span class="form-margin">Both</span><br />
		<input type="radio" name="attyHCP[]" id="prof3" value="[[!+fi.attyHCP:FormItIsChecked=`Other`]]" />
		<span class="form-margin">Other</span><br />
		<textarea name="otherText" id="otherText" class="input-field" value="[[!+fi.otherText]]" style="display:none;" rows="2" cols="15" maxlength="35">&nbsp;</textarea><br /><br />
		Have you ever requested information from LUC before?
		<br />
		<input type="radio" name="reqInfoBefore[]" id="reqInfoBefore1" value="Yes" [[!+fi.reqInfoBefore:FormItIsChecked=`Yes`]] />
		<span class="form-margin">Yes</span>
		<br />
		<input type="radio" name="reqInfoBefore[]" id="reqInfoBefore2" value="No" [[!+fi.reqInfoBefore:FormItIsChecked=`No`]] />
		<span class="form-margin">No</span>
	</div>
	...
	<p class="form-text" style="margin-bottom:10px text-align:center;">
		...
		<div id="content" class="thanks-page">
...
<p class="p1">The MJ and LLM programs are recognized, legitimate legal credentials for those looking to move into positions of health care leadership and policy making. Plus, these programs are 100% Online, offering maximum flexibility and convenience for full-time professionals. To learn more about the MJ and LLM programs and the Beazley Institute for Health Law and Policy, please visit: <a href="http://www.LUC.edu/healthlaw">www.LUC.edu/healthlaw</a>.</p>
			<a href="http://luc.edu/law/centers/healthlaw/about/vis.html" target="_blank" style="display:block;text-decoration:none;">
				<div id="virtual-session">
					...
					<div id="virtual-arrow"><img width="21" height="34" alt="Arrow" src="http://onlinehealthlaw.luc.edu/global_assets/img/arrow.png" /></div>
				</div>
			</a>
		</div>
	</div>

	<a href="javascript:void(0);" id="mobile-form" class="thanks-page">Request More Information</a>
	...
	<!-- JavaScript -->
<script type="text/javascript" src="http://onlinehealthlaw.luc.edu/global_assets/js/libs/jquery-1.9.1.min.js"></script>
<script type="text/javascript" src="http://code.jquery.com/ui/1.10.2/jquery-ui.js"></script>
<script type="text/javascript" src="http://onlinehealthlaw.luc.edu/global_assets/js/plugins.js"></script>
<script type="text/javascript" src="http://onlinehealthlaw.luc.edu/global_assets/js/custom.js"></script>
<script type="text/javascript" src="http://onlinehealthlaw.luc.edu/global_assets/js/libs/helper.js"></script>

	<!--  Conditional Container Tag: Loyola Health Law (3546) | Loyola Health Law Thank You (23175) | Loyola Health Law (2810) | Expected URL:  -->
...
document.write(\'<iframe style="position:absolute; visibility:hidden; width:1px; height:1px;" src="http://servedby.flashtalking.com/container/3546;23175;2810;iframe/?spotName=Loyola_Health_Law_Thank_You&cachebuster=\'+ftRandom+\'"></iframe>\');
  ...
  array (
	...
	<![endif]-->
	<!-- HTML5 Support -->
	<script src="http://onlinehealthlaw.luc.edu/global_assets/js/libs/modernizr-2.6.2.min.js"></script>',
    '[[*id]]' => 18,
    '[[*context_key]]' => 'LoyolaHealthLaw',
    '[[*context_key:is=`TulsaEnergyLaw`:then=`[[!$analytics-tulsa]]`]]' => NULL,
    '[[*context_key:is=`LoyolaHealthLaw`:then=`[[!$analytics-healthlaw]]`]]' => '[[!$analytics-healthlaw]]',
    '[[*pagetitle:is=`Thank You!`:then=`thanks-page`]]' => 'thanks-page',
    '[[~18]]' => 'MJ-LLM/thank-you.html',
    '[[$contactForm_loyola]]' => '[[!FormIt?
	&hooks=`FormSave,redirect`
	&fsFormTopic=`MJ-LLM`
	&redirectTo=`18`
]]
...
',
    ...
    '[[*context_key:is=`LoyolaHealthLaw`:then=`georgia gold`:else=``]]' => 'georgia gold',
...
var ftRandom = Math.random()*1000000;
document.write(\'<iframe style="position:absolute; visibility:hidden; width:1px; height:1px;" src="http://servedby.flashtalking.com/container/3546;23170;2810;iframe/?spotName=Loyola_Health_Law_Homepage&cachebuster=\'+ftRandom+\'"></iframe>\');
</script>`]]' => '<!--  Conditional Container Tag: Loyola Health Law (3546) | Loyola Health Law Thank You (23175) | Loyola Health Law (2810) | Expected URL:  -->
<script type="text/javascript">
var ftRandom = Math.random()*1000000;
document.write(\'<iframe style="position:absolute; visibility:hidden; width:1px; height:1px;" src="http://servedby.flashtalking.com/container/3546;23175;2810;iframe/?spotName=Loyola_Health_Law_Thank_You&cachebuster=\'+ftRandom+\'"></iframe>\');
</script>',
    '[[*context_key:is=`LoyolaHealthLaw`:then=`<!--  Conditional Container Tag: Loyola Health Law (3546) | Loyola Health Law Thank You (23175) | Loyola Health Law (2810) | Expected URL:  -->
<script type="text/javascript">
var ftRandom = Math.random()*1000000;
document.write(\'<iframe style="position:absolute; visibility:hidden; width:1px; height:1px;" src="http://servedby.flashtalking.com/container/3546;23175;2810;iframe/?spotName=Loyola_Health_Law_Thank_You&cachebuster=\'+ftRandom+\'"></iframe>\');
</script>`:else``]]' => '<!--  Conditional Container Tag: Loyola Health Law (3546) | Loyola Health Law Thank You (23175) | Loyola Health Law (2810) | Expected URL:  -->
<script type="text/javascript">
var ftRandom = Math.random()*1000000;
document.write(\'<iframe style="position:absolute; visibility:hidden; width:1px; height:1px;" src="http://servedby.flashtalking.com/container/3546;23175;2810;iframe/?spotName=Loyola_Health_Law_Thank_You&cachebuster=\'+ftRandom+\'"></iframe>\');
</script>',
    '[[*analyticsLabel]]' => 'vCV5COv2wQQQxb7Y3QM',
...
var google_conversion_label = "vCV5COv2wQQQxb7Y3QM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/1001791301/?value=0&amp;label=vCV5COv2wQQQxb7Y3QM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
...
<script type="text/javascript">
  ...
  ga(\'send\', \'pageview\');
    ...
    '[[~16]]' => 'MJ-LLM/career-advancement.html',
    '[[~17]]' => 'MJ-LLM/success-stories.html',
    '[[~15]]' => 'MJ-LLM/online-convenience.html',
    '[[~14]]' => 'MJ-LLM/loyola-degree.html',
  ),
  'sourceCache' => 
  array (
    'modChunk' => 
