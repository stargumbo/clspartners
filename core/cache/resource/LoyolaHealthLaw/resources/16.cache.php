<?php  return array (
  ...
  array (
    ...
    'pagetitle' => 'Career Advancement',
    'longtitle' => 'Career Advancement',
    'description' => '',
    'alias' => 'career-advancement',
    'link_attributes' => '',
    'published' => 1,
    'pub_date' => 0,
    'unpub_date' => 0,
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<div class="page-title">Career <em>Advancement</em></div>
<p class="centered"><img src="global_assets/img/career-advancement.jpg" alt="Career Advancement" width="500" height="162" /></p>
<p>With a Master of Jurisprudence (MJ) in Health Law or a Master of Laws (LLM) in Health Law, Loyola graduates are uniquely positioned to provide expertise for their employers and clients across a broad spectrum of health law issues. Among these are compliance with federal and state regulations, protecting patient data and privacy, and managing institutional risk. Loyola health law graduates are able to comprehend the business, public policy and regulatory environments governing health care and identify key operational and legal issues faced by health care entities and patients.</p>
<p>Since 1987, Loyola graduates have applied their knowledge and expertise in virtually all facets of the health care industry, both elevating their positions and advancing their careers. Many have become not only leaders within their organizations, but difference-makers within the health care field.</p>',
    'richtext' => 1,
    'template' => 1,
    'menuindex' => 4,
    'searchable' => 1,
    ...
    'content_type' => 1,
    'uri' => 'MJ-LLM/career-advancement.html',
    'uri_override' => 0,
...
<head>	<meta charset="utf-8" />
	<title>Loyola University Chicago - Career Advancement</title>
	<base href="[[!++site_url]]" />
...
<body class="id-16 LoyolaHealthLaw">
...
<form id="contact-form" action="MJ-LLM/career-advancement.html" method="post" class="loyola-contact-form">
	...
	<p class="form-text" style="margin-bottom:10px text-align:center;">
		...
		<div id="content" class="[[*pagetitle:is=`Thank You!`:then=`thanks-page`]]">
			<div class="page-title">Career <em>Advancement</em></div>
<p class="centered"><img src="global_assets/img/career-advancement.jpg" alt="Career Advancement" width="500" height="162" /></p>
<p>With a Master of Jurisprudence (MJ) in Health Law or a Master of Laws (LLM) in Health Law, Loyola graduates are uniquely positioned to provide expertise for their employers and clients across a broad spectrum of health law issues. Among these are compliance with federal and state regulations, protecting patient data and privacy, and managing institutional risk. Loyola health law graduates are able to comprehend the business, public policy and regulatory environments governing health care and identify key operational and legal issues faced by health care entities and patients.</p>
<p>Since 1987, Loyola graduates have applied their knowledge and expertise in virtually all facets of the health care industry, both elevating their positions and advancing their careers. Many have become not only leaders within their organizations, but difference-makers within the health care field.</p>
...
<script type="text/javascript" src="http://onlinehealthlaw.luc.edu/global_assets/js/libs/helper.js"></script>
	...
	<!--  Conditional Container Tag: Loyola Health Law (3546) | Loyola Health Law Homepage (23170) | Loyola Health Law (2810) | Expected URL:  -->
...
document.write(\'<iframe style="position:absolute; visibility:hidden; width:1px; height:1px;" src="http://servedby.flashtalking.com/container/3546;23170;2810;iframe/?spotName=Loyola_Health_Law_Homepage&cachebuster=\'+ftRandom+\'"></iframe>\');
    ...
    '[[*analyticsLabel]]' => '2EZiCPv0wQQQxb7Y3QM',
...
var google_conversion_label = "2EZiCPv0wQQQxb7Y3QM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/1001791301/?value=0&amp;label=2EZiCPv0wQQQxb7Y3QM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
