<?php  return array (
  ...
  array (
    ...
    'content' => '<div class="page-title">A <em>Loyola</em> Degree</div>
<p class="centered"><img src="global_assets/img/trust.jpg" alt="Loyola Degree" width="500" height="162" /></p>
<p>Loyola University Chicago is consistently recognized by leading publications as one of the nation’s top universities. The Beazley Institute for Health Law and Policy at Loyola University Chicago School of Law was established in 1984. Since that time, the Institute has become a nationally renowned leader in health law education. Today, with over 1,000 alumni worldwide, many of whom occupy positions of prominence in leadership and policymaking throughout the health care industry, Loyola’s Beazley Institute for Health Law and Policy is at the forefront of educating the health law leaders of tomorrow.</p>',
    'richtext' => 1,
    'template' => 1,
    'menuindex' => 1,
    'searchable' => 1,
...
<head>	<meta charset="utf-8" />
	<title>Loyola University Chicago - A Loyola Degree</title>
	<base href="[[!++site_url]]" />
...
<body class="id-14 LoyolaHealthLaw">
...
<form id="contact-form" action="MJ-LLM/loyola-degree.html" method="post" class="loyola-contact-form">
	...
	<p class="form-text" style="margin-bottom:10px text-align:center;">
		...
		<div id="content" class="[[*pagetitle:is=`Thank You!`:then=`thanks-page`]]">
			<div class="page-title">A <em>Loyola</em> Degree</div>
<p class="centered"><img src="global_assets/img/trust.jpg" alt="Loyola Degree" width="500" height="162" /></p>
<p>Loyola University Chicago is consistently recognized by leading publications as one of the nation’s top universities. The Beazley Institute for Health Law and Policy at Loyola University Chicago School of Law was established in 1984. Since that time, the Institute has become a nationally renowned leader in health law education. Today, with over 1,000 alumni worldwide, many of whom occupy positions of prominence in leadership and policymaking throughout the health care industry, Loyola’s Beazley Institute for Health Law and Policy is at the forefront of educating the health law leaders of tomorrow.</p>
...
document.write(\'<iframe style="position:absolute; visibility:hidden; width:1px; height:1px;" src="http://servedby.flashtalking.com/container/3546;23170;2810;iframe/?spotName=Loyola_Health_Law_Homepage&cachebuster=\'+ftRandom+\'"></iframe>\');
    ...
    '[[*analyticsLabel]]' => 'vbhZCIvzwQQQxb7Y3QM',
...
var google_conversion_label = "vbhZCIvzwQQQxb7Y3QM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/1001791301/?value=0&amp;label=vbhZCIvzwQQQxb7Y3QM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
